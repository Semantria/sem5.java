...
To run the example:
    ...
    $ java -cp 'target/sem5-sdk-examples-6.28.0.jar;target/lib/*' com.lexalytics.semantria.example.DetailedModeExample --credentials <username>:<password> ../example-data/tweets.txt
    Sending 100 docs...
...
To see the options supported:
    ...
    $ java -cp 'target/sem5-sdk-examples-6.28.0.jar;target/lib/*' com.lexalytics.semantria.example.DetailedModeExample --help
